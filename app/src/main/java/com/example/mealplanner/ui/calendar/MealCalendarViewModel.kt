package com.example.mealplanner.ui.calendar
...
import com.example.mealplanner.data.MealPlanWithRecipe
...
import com.example.mealplanner.sync.FirebaseSyncManager
        ...
        viewModelScope.launch {
            familyIds.forEach { familyId ->
                mealPlanDao.insertWeeklyPlanFamilyCrossRef(
                    com.example.mealplanner.data.WeeklyPlanFamilyCrossRef(weeklyPlanId, familyId)
                )
            }
            loadWeeklyPlans()
